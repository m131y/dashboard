package com.my131.dashboard.repository;

import com.my131.dashboard.DashboardApplication;
import com.my131.dashboard.model.CustomerRank;
import com.my131.dashboard.model.DailySales;
...
public class DashboardRepository {
    ...
    public void saveSale(LocalDate saleDate, int customerId, BigDecimal amout) {
        jdbcTemplate.update(
                "INSERT INTO sales (sale_date, customer_id, amount) VALUES (?, ?, ?)",
                saleDate, customerId, amout
        );
    }
}
